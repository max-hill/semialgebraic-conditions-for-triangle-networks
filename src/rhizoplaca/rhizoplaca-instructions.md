...
The best five networks we obtained by running the above code are saved in 
[rhizoplaca-networks.txt](../../data/best-rhizoplaca-networks.txt).
The top-scoring network we obtained was
